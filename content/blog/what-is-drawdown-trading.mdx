...
- BrightFunded: Same model — 10% static max drawdown, floor never moves

**Trailing drawdown:** The floor rises as your balance increases, up to a point.
- Apex Trader Funding: Trailing drawdown rises with profits until floor reaches starting balance
...
- Static drawdown (FTMO, FundedNext, BrightFunded) is more forgiving than trailing drawdown (Apex Trader Funding)
